      ...
      <div className="mt-24 px-4 sm:px-6 md:px-12 lg:px-28">
        ...
        <div className="mt-6">
          ...
          <div className="flex flex-col gap-1.5">
            <TechIconsRow
              label="Backend"
              icons="php,python,fastapi,nodejs,express"
            />
            <TechIconsRow
              label="Frontend"
              icons="html,css,js,react,nextjs,tailwindcss,electron"
            />
            <TechIconsRow
              label="Databases"
              icons="sqlite,mysql,postgres,mongodb"
            />
            <TechIconsRow label="BaaS" icons="firebase,supabase" />
            <TechIconsRow label="Linux" icons="arch,ubuntu,bash" />
            <TechIconsRow
              label="DevOps"
              icons="git,github,docker,nginx,ngrok,postman"
            />
